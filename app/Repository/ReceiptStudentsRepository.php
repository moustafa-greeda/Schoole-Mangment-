...
class ReceiptStudentsRepository implements ReceiptStudentsRepositoryInterface
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('receipt_students.index')->with('success', trans('messages.success'));
    ...
    public function update($request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('receipt_students.index')->with('success', trans('messages.Update'));
        } catch (\Exception $e) {
            DB::rollback();
            return redirect()->back()->withErrors(['error' => $e->getMessage()]);
        }
