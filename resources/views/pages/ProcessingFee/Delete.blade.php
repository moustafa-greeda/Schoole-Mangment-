    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('Fee_trans.Delete_Processing_Fee')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('ProcessingFee.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;"></h5>{{trans('Fee_trans.Deleted_Fee')}}</h5>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">{{trans('Fee_trans.Close')}}</button>
                        <button  class="btn btn-danger">{{trans('Fee_trans.submit')}}</button>
                    </div>
                </form>
            </div>
        </div>
