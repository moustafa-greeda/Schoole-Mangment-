...
@section('title')
    {{trans('Fee_trans.Edit_Proccessing_Fee')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{trans('Fee_trans.Edit_Proccessing_Fee')}} : <label style="color: red">{{$ProcessingFee->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('Fee_trans.Note')}} : <span class="text-danger">*</span></label>
                            ...
                            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('Fee_trans.submit')}}</button>
                        </form>
