...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{trans('Question_trans.Edit_Question')}}  :<span class="text-danger">{{$question->title}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('Questions.update','test') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title"> {{trans('Question_trans.Name_Question')}} </label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title"> {{trans('Question_trans.Answers')}}</label>
