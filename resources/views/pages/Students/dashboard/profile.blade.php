                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('student_profile.update',$information->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{trans('Teacher_trans.Name_User_ar')}}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{trans('Teacher_trans.Name_User_en')}}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{trans('main_trans.Password')}}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                ...
                                <hr>
                                <button type="submit" class="btn btn-success">{{trans('Teacher_trans.Edit_Data')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
