...
@section('title')
    {{trans('Fee_trans.Add_New_Invoicess')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{trans('Fee_trans.Add_New_Invoicess')}} {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                    ...
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name" class="mr-sm-2">{{trans('Fee_trans.Student_Name')}}</label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{trans('Fee_trans.Fee_Type')}}</label>
                                                    <div class="box">
                                                        <select class="fancyselect" name="fee_id" required>
                                                            <option value="">-- {{trans('Fee_trans.Choose_From_List')}} --</option>
                                                            @foreach($fees as $fee)
                                                ...
                                                <div class="col">
                                                    <label for="description" class="mr-sm-2">{{trans('Fee_trans.Note')}}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{trans('Fee_trans.Proccesses')}}:</label>
